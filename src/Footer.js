    ...
    <Fade>
      <section className="footer" id="contact">
        <div className="footer__email">
          <Fade right>
            <a href="mailto:bsudhanshu3@gmail.com">
        ...
        <div className="footer__info">
          <div className="footer__links">
            ...
            <a href="https://github.com/Sudhanshu-bh" target="_blank" rel="noreferrer">
          ...
          <div className="footer__name">&copy; 2021 | Made by <u>Sudhanshu Bhardwaj</u></div>
        </div>
      </section>
    </Fade>
  )
